...
<section id= "featured" class="my-5 pb-5">
        ...
        <div onclick="window.location.href='singleproduct.html';"class="row mx-auto container-fluid">
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/flaredCargo.png" width="300" height="350" alt="">
                <div class="star">
            ...
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/BaggyCargoPants.png" width="300" height="350" padding="10px" alt="">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/baggyDenimCargos.png" width="300" height="350" alt="">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <br>
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/LowriseFlaredCargo.png" width="300" height="350" alt="">
                <div class="star">
            ...
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/BaggyMultipocket.png" width="300" height="350" alt="">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="product text-center col-lg-3 col-md-4 col-12">
                <img src="resource/images/baggyCargos.png" width="300" height="350" alt="">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
