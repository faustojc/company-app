...
function Category() {
    return (
        <ul className="navbar-nav mx-auto">
            ...
            <li className="nav-item mx-2">
                <a href="#" className="nav-link fw-light">TRENDING</a>
            </li>
            <li className="nav-item mx-2">
                <a href="#" className="nav-link fw-light">NEW</a>
            </li>
            <li className="nav-item mx-2 dropdown">
                <a href="#categoryDropdown" className="nav-link fw-light dropdown-toggle" id="categoryDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    CATEGORY
                </a>

                <div className="dropdown-menu rounded-0 animate__animated animate__fadeInUp animate__faster" id="categoryDropdown" aria-labelledby="categoryDropdown">
                    <a href={ route('products.index') } className="dropdown-item">
                        Cargo Pants
                    </a>
                    <a href={ route('products.index') } className="dropdown-item">
                        Denim Jeans
                ...
                <div className="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <div className="d-flex align-items-center justify-content-between justify-content-lg-end mt-2 my-lg-0">
                        <div className="nav-item mx-lg-3">
                            <Navbar.AuthDisplay username={ customer ? '' : customer } />
                        </div>
                        <div className="nav-item mx-lg-3">
                            <a href={
                                customer ? route('orders.index') : route('login')
